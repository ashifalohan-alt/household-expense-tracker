                    ...
                    <div style={{ display: "flex", gap: "0.5rem" }}>
                      {!u.is_approved && (
                        <button onClick={() => handleApproveUser(u.id)}
                          style={{ padding: "0.5rem", borderRadius: "0.5rem", border: "none", backgroundColor: "var(--income)", cursor: "pointer", display: "flex", alignItems: "center" }}>
                          <CheckCircle size={18} color="white" />
                        </button>
                      )}
                      {u.is_approved && (
                        <button onClick={() => handleRemoveUser(u.id)}
                          style={{ padding: "0.5rem", borderRadius: "0.5rem", border: "none", backgroundColor: "var(--expense)", cursor: "pointer", display: "flex", alignItems: "center" }}>
